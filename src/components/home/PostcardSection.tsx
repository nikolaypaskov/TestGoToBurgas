...
export function PostcardSection({ locale, dict }: PostcardSectionProps) {
  return (
    <section className="relative h-[60vh] sm:h-[65vh] lg:h-[70vh] overflow-hidden">
      ...
      {/* Left-to-right gradient overlay (not top-to-bottom, for variety) */}
      <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent" />

      {/* Content — left-aligned */}
      <div className="relative z-10 flex h-full items-center">
        <div className="max-w-2xl px-6 sm:px-12 lg:px-20">
          <p className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white leading-tight">
